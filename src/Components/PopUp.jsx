    ...
    <section className="absolute z-10 h-screen w-screen bg-black bg-opacity-80 text-white">
      <div className="absolute left-1/2 top-1/2 z-20 flex h-2/3 w-2/3 -translate-x-1/2 -translate-y-1/2 transform flex-col items-center justify-center gap-y-10 border-2 border-lime-500 bg-gray-900">
        ...
        <p className="w-2/3">
          ...
          <br />- Muito importante: Se o site for fechado ou se ficar mais de 5
          minutos fora do site, este será atualizado e perderá o progresso.{' '}
          <br />- O acesso ao prompt está na caixa &quot;full prompt here&quot;,
          onde também se encontram os requisitos de JCL. <br /> - Vote no
          resultado: <br />- Modelo A vence: Se o código do Modelo A for
          ...
          código: <br /> <br /> -Representação: O código representa o que é
          esperado com base nos requisitos? <br /> -Clareza: O código é claro e
          fácil de entender? <br /> <br /> Avalie as partes funcionais do
          código, ignorando quaisquer partes irrelevantes <br />
